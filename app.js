...
search.addEventListener('click', function () {
    ...
    fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${ foodName }`)
        ...
        .then(data => {
            ...
            document.getElementById('displayFoodsData').innerHTML = ' ';
...
let handlefoodClick = foodId => {
    fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${ foodId }`)
        .then(res => res.json())
        .then(data => {
            let foodData = document.getElementById('displayFoodsData');
            document.getElementById('displayFoodsData').innerHTML = ' ';
            document.getElementById('displayFoodsData').style.display = 'block';
